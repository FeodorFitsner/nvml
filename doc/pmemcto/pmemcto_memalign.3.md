...
[comment]: <> (pmemcto_memalign.3 -- man page for libpmemcto)
...
The **pmemcto_aligned_alloc**() function return a pointer to the allocated
memory.  If **pmemcto_aligned_alloc**() is unable to satisfy the allocation
